<template>
  <div class="two-state-toggle">
    <div
      class="two-state-toggle__option two-state-toggle__option--one"
      :class="{ 'two-state-toggle__option--selected': optionOneSelected }"
      @click="onOptionOneClick"
    >
      <div class="two-state-toggle__label">{{ toggleOneText }}</div>
    </div>
    <div
      class="two-state-toggle__option two-state-toggle__option--two"
      :class="{ 'two-state-toggle__option--selected': optionTwoSelected }"
      @click="onOptionTwoClick"
    >
      <div class="two-state-toggle__label">{{ toggleTwoText }}</div>
    </div>
  </div>
</template>
