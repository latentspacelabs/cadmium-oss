...
if __name__ == "__main__":
    ...
    if not args.debug:
        os.environ["COMET_PROJECT_NAME"] = "ant_v1"
    else:
        os.environ["COMET_PROJECT_NAME"] = "ant_v1_debug"
    ...
    if args.checkpoint:
        model = AnTV1Model.from_pretrained(args.checkpoint)
        model_config = model.config
    else:
        model_config = AnTV1Config()
        model = AnTV1Model(model_config)
    model.to("cuda")
